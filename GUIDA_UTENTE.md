...
4. Scegli il **Livello** del mazzo (vedi sotto).
...
Tutti i mazzi con il loro win rate. Puoi **filtrare** per:
...
- **Mazzi** — gestisce i mazzi di **tutti** i giocatori (nome, commander, colori, livello, lista).
